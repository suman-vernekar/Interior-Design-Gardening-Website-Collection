...
<body>
        ...
        <div class="div">
            <div class="estimate-card">
                ...
                <div class="estimate-text">
                    ...
                    <div>Superior home interior solutions that will take your interiors to the next level.</div>
                </div>
            </div>
        </div>
    ...
    <script>
        // Generate random estimates between 3L and 7L
        const minEstimate = (Math.random() * (5 - 3) + 3).toFixed(1); // Random number between 3L and 5L
        const maxEstimate = (Math.random() * (7 - 5) + 5).toFixed(1); // Random number between 5L and 7L
