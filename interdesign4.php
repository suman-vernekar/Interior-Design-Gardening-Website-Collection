...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("INSERT INTO contact (fname, email, phone_code, phone, property, whatsapp_updates) VALUES (?, ?, ?, ?, ?, ?)");
        ...
        if ($stmt->execute()) {
            ...
            header("Location: interdesign.php");
            exit();
        } else {
